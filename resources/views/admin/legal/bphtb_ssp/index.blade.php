                        ...
                        <div class="card">
                            <div class="card-header p-3">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-xl">Data Bphtb & Ssp</h3>
                ...
                <form id="formData" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h6 class="font-weight-bold mb-2">BPHTB</h6>
                                <div class="form-group">
                                    <select name="status_bphtb" id="status_bphtb" class="form-control select-bphtb">
                                        <option value=""></option>
                            ...
                            <div class="col-md-6">
                                <h6 class="font-weight-bold mb-2">SSP</h6>
                                <div class="form-group">
                                    <select name="status_ssp" id="status_ssp" class="form-control select-ssp">
                                        <option value=""></option>
                                        <option value="ada">Ada</option>
                                        <option value="tidak ada">Tidak ada</option>
                                    </select>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.edit-button', function () {
            ...
            $.get(url, function (response) {
                if (response.status === 'success') {
                    ...
                    $('#modalFormLabel').text('Edit BPHTB & SSP');
                    ...
                    setTimeout(function () {
                        $('#status_bphtb')
                            .val(response.data.status_bphtb)
                            .trigger('change');
                    }, 150);
                    setTimeout(function () {
                        $('#status_ssp')
                            .val(response.data.status_ssp)
                            .trigger('change');
                    }, 150);
                }
            });
        ...
        $('#modalForm').on('hidden.bs.modal', function() {
            ...
            $('.select-bphtb').val(null).trigger('change');
            $('.select-ssp').val(null).trigger('change');
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('bphtb-ssp.update', ['bphtb_ssp' => ':id']) }}'.replace(':id', id) :
                '{{ route('bphtb-ssp.store') }}';
