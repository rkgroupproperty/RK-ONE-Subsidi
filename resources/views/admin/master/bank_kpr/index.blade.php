                        ...
                        <div class="card">
                            <div class="card-header p-3">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-lg">Data Bank KPR</h3>
                                    <div class="d-flex align-items-center">
                                        @if ($permissions['tambah'])
                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                                data-target="#modalForm">
                                                <i class="fas fa-plus"></i> Tambah Bank KPR
                                            </button>
                                        @endif
                                    </div>
                                </div>
                    ...
                    <form id="formData">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="nama" class="col-sm-4 col-form-label">Nama Bank</label>
                                <div class="col-sm-8">
...
@push('scripts')
    <script>
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('bank-kpr.update', ['bank_kpr' => ':id']) }}'.replace(':id', id) :
                '{{ route('bank-kpr.store') }}';
