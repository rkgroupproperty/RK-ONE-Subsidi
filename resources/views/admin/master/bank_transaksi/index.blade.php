                        ...
                        <div class="card">
                            <div class="card-header p-3">
                                <div class="d-flex align-content-center justify-content-between">
                                    <h3 class="font-weight-bold text-lg">Data Bank Transaksi</h3>
                                    <div class="d-flex align-items-center">
                                        @if ($permissions['tambah'])
                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                                data-target="#modalForm">
                                                <i class="fas fa-plus"></i> Tambah Bank Transaksi
                                            </button>
                                        @endif
                                    </div>
                                </div>
                    ...
                    <form id="formData">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="nama" class="col-sm-4 col-form-label">Rekening</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="pemilik_rek" class="col-sm-4 col-form-label">Pemilik Rek</label>
                                <div class="col-sm-8">
    ...
    <script>
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                ordering: false,
                responsive: true,
                ajax: "{{ route('bank-transaksi.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '{{ route('bank-transaksi.update', ['bank_transaksi' => ':id']) }}'.replace(':id', id) :
                '{{ route('bank-transaksi.store') }}';
