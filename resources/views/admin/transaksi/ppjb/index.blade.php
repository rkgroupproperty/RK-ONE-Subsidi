                            ...
                            <div class="card-header p-3">
                                <div class="d-flex align-content-center justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('export.transaksi.ppjb') }}" target="_blank" class="btn btn-sm btn-success mr-2"><i class="fas fa-file-excel mr-1"></i> Excel</a>
                ...
                <form id="formData">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row mb-3">
                            <label for="tanggal_ppjb" class="col-sm-3 col-form-label">Tanggal</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="acc_plafon" id="acc_plafon" class="form-control" readonly>
                            </div>
                            <label class="col-sm-3 col-form-label">Sisa Bayar</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="text" name="termin" id="termin" class="form-control format-number">
...
@push('scripts')
    <script>
        ...
        $(document).on('change', '#id_customer', function() {
            ...
            if (!id) {
                $('#nik, #alamat_ktp, #lokasi_rumah, #tipe_bangunan, #luas_tanah, #luas_bangunan, #nama_marketing, #acc_plafon, #sisa_bayar')
                    .val('')
                return
            }
            ...
            $.get(url, function(res) {
                ...
                $('#acc_plafon').val(formatNumber(res.wawancara_acc_plafon) || '')
                $('#sisa_bayar').val(formatNumber(res.sisa_bayar) || '')
            })
        })
